 ...
 * @author ILYA_
 */
public class JFramePOT2 extends javax.swing.JFrame {

    /**
     * Creates new form JFramePOT2
     */
    public JFramePOT2() {
        initComponents();
                Seticon();
    ...
    private void initComponents() {
        ...
        jLabel4.setText("ПЛИТКА ГИПСОКАРТОНОВАЯ");
        ...
        jLabel6.setText("Длина потолка(м):");

        jLabel7.setFont(new java.awt.Font("Arial", 1, 18)); // NOI18N
        jLabel7.setText("Ширина потолка(м):");
        ...
        jLabel14.setText("Площадь потолка(м2):");
        ...
        jPanel3.add(jLabel18, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 1200, 660));
  ...
  jTextField5.setBackground(Color.white);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JFramePOT2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
