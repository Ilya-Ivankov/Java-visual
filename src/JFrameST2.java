...
public class JFrameST2 extends javax.swing.JFrame {

    /**
     * Creates new form JFrameST2
     */
    public JFrameST2() {
        initComponents();
                Seticon();
    ...
    private void initComponents() {
        ...
        jLabel2.setText("РАСЧЁТ МАТЕРИАЛОВ ДЛЯ СТЕН");
        ...
        jLabel7.setText("Длина поверхности(м):");

        jLabel8.setFont(new java.awt.Font("Arial", 1, 22)); // NOI18N
        jLabel8.setText("УКАЖИТЕ ПАРАМЕТРЫ:");

        jLabel9.setFont(new java.awt.Font("Arial", 1, 18)); // NOI18N
        jLabel9.setText("Ширина поверхности(м):");

        jLabel10.setFont(new java.awt.Font("Arial", 1, 18)); // NOI18N
        jLabel10.setText("Расход краски кв.м / л:");

        jLabel11.setFont(new java.awt.Font("Arial", 1, 18)); // NOI18N
        jLabel11.setText("Количество слоев(шт):");

        jLabel12.setFont(new java.awt.Font("Arial", 1, 18)); // NOI18N
        jLabel12.setText("Объем банки (л)");
        ...
        jLabel18.setText("Цена за банку:");
        ...
        jLabel14.setText("Кол-во банок:");

        jLabel15.setFont(new java.awt.Font("Arial", 1, 18)); // NOI18N
        jLabel15.setText("Площадь окраски(м2):");

        jLabel16.setFont(new java.awt.Font("Arial", 1, 18)); // NOI18N
        jLabel16.setText("Кол-во литров:");
        ...
        jLabel19.setText("Общая стоимость:");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        float c = Float.parseFloat(jTextField2.getText());
               float E = Float.parseFloat(jTextField9.getText());
        if ((b == 0) || (a == 0) || (c == 0) || (e == 0) || (E == 0)){
            jLabel17.setText("ЗАПОЛНИТЕ ВСЕ ПОЛЯ!");
            if (a == 0 || a < 0){
                jTextField1.setBackground(Color.red);
            }
            ...
            int TTR = (int)Math.ceil(ce);
            float TT = ce *E;
            String PP =jComboBox1.getSelectedItem().toString();
              int PP1 = Integer.parseInt(PP);
            float EEE = (ab/c)*PP1;  
            jTextField10.setText(String.valueOf((TT)));
            jTextField7.setText(String.valueOf((TTR)));
            jTextField6.setText(String.valueOf(a*b));
            jTextField8.setText(String.valueOf(EEE));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JFrameST2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
