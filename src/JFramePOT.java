 ...
 * @author ILYA_
 */
public class JFramePOT extends javax.swing.JFrame {

    /**
     * Creates new form JFramePOT
     */
    public JFramePOT() {
        initComponents();
                Seticon();
    ...
    private void initComponents() {
        ...
        jLabel4.setText("НАТЯЖНОЙ ПОТОЛОК");
        ...
        jLabel18.setText("Количесто светильников:");

        jLabel19.setFont(new java.awt.Font("Arial", 1, 18)); // NOI18N
        jLabel19.setText("Количество углов: ");
        ...
        jLabel13.setText("Площадь материала:");
        ...
        jPanel3.add(jLabel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 1200, 690));
...
if (E == 0 || E < 0){
  jTextField6.setBackground(Color.red);  
    ...
    jLabel20.setText("");
         ...
         String PP =jComboBox1.getSelectedItem().toString();
         int PP1 = Integer.parseInt(PP);
         String PZ =jComboBox2.getSelectedItem().toString();
         int PZ1 = Integer.parseInt(PZ);
         float qw = (float) (PP1 * 0.02);
         float qw1 = (float) (PZ1 * 0.30);
        float ab = a*b;
        jTextField8.setText(String.valueOf(ab-qw-qw1));
        jTextField10.setText(String.valueOf(ab*E));
...
jTextField6.setBackground(Color.white);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JFramePOT.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
